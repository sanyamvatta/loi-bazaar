...
function submitForm() {
    ...
    const message = `Hello LOI Bazaar,%0aHappy : 9855071280%0a%0aSri Ambe Realtors%0a%0aI am looking to *${currentState.intent.toUpperCase()}* an LOI.%0a%0a📍 *Location:* ${locationFull}%0a🏠 *Type:* ${currentState.type}%0a📏 *Size:* ${currentState.size}%0a%0aPlease contact me at the earliest.`;
